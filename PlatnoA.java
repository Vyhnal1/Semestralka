 ...
 */
public class PlatnoA {
    // Note: The implementation of this class (specifically the handling of
    // shape identity and colors) is slightly more complex than necessary. This
    // is done on purpose to keep the interface and instance fields of the
    // shape objects in this project clean and simple for educational purposes.

    private static PlatnoA PlatnoASingleton;

    /**
     * Factory method to get the canvas singleton object.
     */
    public static PlatnoA dajPlatnoA() {
        if (PlatnoA.PlatnoASingleton == null) {
            PlatnoA.PlatnoASingleton = new PlatnoA("Digitalne hodiny", 800, 300, 
                                         Color.white);
        }
        PlatnoA.PlatnoASingleton.setVisible(true);
        return PlatnoA.PlatnoASingleton;
    }
     ...
     */
    private PlatnoA(String titulok, int sirka, int vyska, Color pozadie) {
    ...
    private class CanvasPane extends JPanel {
        public void paint(Graphics graphic) {
            graphic.drawImage(PlatnoA.this.canvasImage, 0, 0, null);
        }
    }
    ...
    private class PopisTvaru {
        ...
        public void draw(Graphics2D graphic) {
            PlatnoA.this.setForegroundColor(this.farba);
